...
<nav class="sub-nav-bar" lang="<?php echo $doc_lang ?>">
	<a <?php echo ($domain_handle == 'contribute')?'class="active"':'' ?>
		...
		class="glyphicon glyphicon-heart"></span> <?php echo ProjectInfo::getDomainName ($project_id, 'contribute') ?></a>
	<a <?php echo ($domain_handle == 'community')?'class="active"':'' ?>
		...
		class="glyphicon glyphicon-group"></span> <?php echo ProjectInfo::getDomainName ($project_id, 'community') ?></a>
	<a <?php echo ($domain_handle == 'document')?'class="active"':'' ?>
		...
		class="glyphicon glyphicon-book"></span> <?php echo ProjectInfo::getDomainName ($project_id, 'document') ?></a>
	<a <?php echo ($domain_handle == 'download')?'class="active"':'' ?>
		...
		class="glyphicon glyphicon-download"></span> <?php echo ProjectInfo::getDomainName ($project_id, 'download') ?></a>
	<a <?php echo ($domain_handle == 'home')?'class="active"':'' ?>
		href="<?php echo ProjectInfo::assemblePath ($project_id, 'home') ?>" class="tab-item"><span
		class="glyphicon glyphicon-home"></span> <?php echo ProjectInfo::getDomainName ($project_id, 'home') ?></a>
<?php
