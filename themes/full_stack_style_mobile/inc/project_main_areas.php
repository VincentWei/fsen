...
?>
				<section class="col-md-4 visible-on-edit-document-right alert alert-info alert-dismissible">
...
?>
				<div class="col-md-12 visible-on-edit-document-right alert alert-info alert-dismissible">
					...
					<a class="dialog-launch"
							...
							dialog-width="80%"
							dialog-height="90%"
							href="/index.php/tools/add_new_section.php<?php echo $common_request_parts . '&areaHandle=Main' ?>">
						<span class="glyphicon glyphicon-circle-plus"></span>
					</a>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12 visible-on-edit-document-right alert alert-info alert-dismissible">
					...
					<a class="dialog-launch"
							...
							dialog-width="80%"
							dialog-height="90%"
							href="/index.php/tools/add_new_section.php<?php echo $common_request_parts . '&areaHandle=MainReversed' ?>">
						<span class="glyphicon glyphicon-circle-plus"></span>
					</a>
				</div>
<?php
