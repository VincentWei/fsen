		...
		<section class="header-block block-right">
			<nav>
				...
				<ul id="ulGlobalNavList" style="display:none;">
					...
					<li>
						<a class="menu-item with-icon"
								href="/<?php echo $doc_lang ?>/engineer/<?php echo $_SESSION['FSEInfo']['user_name'] ?>"
								title="Personal homepage"><span class="glyphicon glyphicon-cogwheel"></span>
							<?php echo $_SESSION['FSEInfo']['nick_name'] ?></a>
					</li>
					<li>
						<a class="menu-item with-icon"
								href="/fse_logout/logout"><span class="glyphicon glyphicon-log-out"></span>
